...
<div>
    <?php foreach ($reservation as $r): ?>  
        ...
        <div class="btn-group pr-1" role="group" aria-label="Basic example" style="width: 100%;">
            ...
            <button class = "btn btn-outline-danger" type = "submit" name = "supprimer" value="<?php echo $r['res_id']; ?>" onclick="return confirm('Êtes vous sur de vouloir supprimer la réservation ?')">Supprimer la réservation</button>
